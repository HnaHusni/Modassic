...
<head>
	...
	<title>Modassice - order page</title>
</head>
<body>
					...
					<div class="box" <?php if($fetch_order['status']=='cancle'){echo 'style="border:2px solid red";';} ?>>
						<a href="view_order.php?get_id=<?= $fetch_order['id']; ?>">
							...
							<div class="row">
								...
								<p class="status" style="color:<?php if($fetch_order['status']=='delivered'){echo 'black';}elseif($fetch_order['status']=='canceled'){echo 'black';}else{echo 'black';} ?>"><?= $fetch_order['status']; ?></p>
							</div>
						</a>
