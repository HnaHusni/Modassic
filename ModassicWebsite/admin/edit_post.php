...
<body>
	...
	<div class="main">
		...
		<div class="title2">
			<a href="dashboard.php">Dashboard </a><span>/ edit post</span>
		</div>
					...
					<div class="input-field">
						...
						<?php if($fetch_posts['image'] != ''){ ?>
							...
							<div class="flex-btn">
								...
								<a href="view_posts.php" class="btn" style="width:49%; text-align: center; height: 2.4rem; margin-top: .6rem;">go back</a>
							</div>
